...
class UserAccount(AbstractBaseUser, PermissionsMixin):
    ...
    user_types = models.CharField(max_length=10)
...
class AttendanceReport(models.Model):
    id = models.AutoField(primary_key=True)
    student_id = models.ForeignKey(UserAccount, on_delete=models.DO_NOTHING)
...
class FeedBackUserAccount(models.Model):
    id = models.AutoField(primary_key=True)
    staff_id = models.ForeignKey(UserAccount, on_delete=models.CASCADE)
    feedback = models.TextField()
    feedback_reply = models.TextField(default="")
...
class NotificationUserAccount(models.Model):
    id = models.AutoField(primary_key=True)
    staff_id = models.ForeignKey(UserAccount, on_delete=models.CASCADE)
    message = models.TextField()
    created_at = models.DateTimeField(auto_now_add=True)
